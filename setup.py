...
setup(
   name='ptycho_pmace_papers',
   description='Python code for PMACE (Projected Multi-Agent Consensus Equilibrium) Papers',
   maintainer='Qiuchen Zhai',
   maintainer_email='qzhai@purdue.edu',
   url="https://github.com/cabouman/ptycho_pmace_papers",
